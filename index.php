      ...
      <div class="container">
        <div class="home-bio-content">
          ...
          <div class="home-bio-details">
            ...
            <a href="<?php echo $short_bio['link_to_bio_url'] ?>" class="btn btn-outline-light"><?php echo $short_bio['link_to_bio_text'] ?></a>
            <?php endif; ?>
          </div>
        </div>
      </div>
  ...
  $title = get_field('testimonials_section_title', 'option');?>
      <section class="home-testimonials">
        ...
        <?php endif; ?>
          ...
          <a href="<?php echo $testimonials_url ?>" class="btn btn-outline-primary more-testimonials"
